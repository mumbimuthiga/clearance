                                        ...
                                        <div class="table-responsive m-t-10">
                                            <table id="myTable" class="table table-bordered table-striped">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php  if(empty($timestamp)){}else{ echo date("d-m-Y", $timestamp);} ?></td>
                                                    <td>
                                                        <div class="dropdown">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-6" style="border-right: solid 1px lightgrey">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input style="color: red" type="text" name="unavailable_from"  readonly value="<?php echo  $status_name=get_status_name($row->status)   ;?>"  class="form-control" autocomplete="off" required >
                                                                                    </div>
                                                                                </div>
