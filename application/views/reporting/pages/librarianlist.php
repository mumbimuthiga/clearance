                                                        ...
                                                        <div class="modal-dialog modal-lg" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="row">
                                                                        <div class="col-sm-12">
                                                                            <form action="<?php echo base_url('student/librarian_approval/'.$row->id) ;?>" method="post" id="enqry_form"><?php ?>
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-6" style="border-right: solid 1px lightgrey">
                                                                                        ...
                                                                                        <?php
                                                                                        $offence=get_admissionlibrarystatus($row->adm_no);
                                                                                    ...
                                                                                    <div class="col-sm-6" style="border-right: solid 1px lightgrey">
                                                                                        ...
                                                                                        <span style="color:red; font-weight: bold;font-size: medium">Kindly return : <?php  echo $offence;?></span>
                                                                                        </div>
                                                                                    </div>
                                                                                    <?php }?>
