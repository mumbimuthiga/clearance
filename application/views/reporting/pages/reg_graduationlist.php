                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <?php if($row->status!=2){ ?>
                                                        <li> <a class="dropdown-item" href="<?php echo base_url('Student/approvereg/'.$row->id)?>">Approve</a></li>
                                                      <?php }?>
                                                        <li><a class="dropdown-item" onclick="deactivate_staff(<?php echo $row->id; ?>,'<?php ?>');">Decline</a>
    ...
    function deactivate_staff(id, name)
    {
        swal({
            ...
            function () {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('Student/decline_request/'); ?>" + id,
                    beforeSend: function () {
