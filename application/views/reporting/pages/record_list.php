                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-responsive m-t-10">
                                            <table id="recordsrpt" class="table table-bordered table-striped">
                                                <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>FullName</th>
                                                        ...
                                                        <div class="modal-dialog modal-lg" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="row">
                                                                        <div class="col-sm-12">
                                                                            <form action="<?php echo base_url('student/record_approval/'.$row->id) ;?>" method="post" id="enqry_form"><?php ?>
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-6" style="border-right: solid 1px lightgrey">
                                                                                        <div class="form-group">
                                                                                            <label for="date_to">
                                                                                                Status
                                                                                                <?php $offence=get_admissionfinancestatus($row->adm_no);
                                                                                                ?>
                                                                                            </label>
                                                                                            <input type="text" name="unavailable_from"  readonly value="<?php echo get_status_name(get_admissionstatus($row->adm_no));;  ;?>"  class="form-control" autocomplete="off" required >
                                                                                        </div>
                                                                                    </div>
                                                                                    <?php


                                                                                    if(empty($offence)){}else{?>
                                                                                        <div class="col-sm-6" style="border-right: solid 1px lightgrey">
                                                                                            <div class="form-group">
                                                                                                <label for="date_to" style="color: red">
                                                                                                    Finance  Status
                                                                                                </label>
                                                                                                <input type="text" name="unavailable_from"  readonly value="<?php echo "Not Cleared";  ;?>"  style="color: red" class="form-control" autocomplete="off" required >
                                                                                                <span style="color:red; font-weight: bold;font-size: medium">Balance : <?php  echo $offence;?></span>
                                                                                            </div>
                                                                                        </div>
                                                                                    <?php }?>
                                                                                    ...
                                                                                    <div class="col-sm-12">
                                                                                        ...
                                                                                        <div class="text-center">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <?php if(get_admissionstatus($row->adm_no)==10){}else{ ?>
                                                                                                        <button class="btn btn-success pull-right" type="submit">
                                                                                                            &nbsp;Issue Transcripts & Certificate
                                                                                                        </button>
                                                                                                    <?php }?>
