...
class Mpesa
{
    ...
    public function __construct()
    {
        ...
        $this->CI->config->load('mpesa-sample', true);

        $mpesa_config = $this->CI->config->item('mpesa-sample');
        ...
        $this->pass_key = $mpesa_config['pass_key'];
        $this->callBackUrl = $mpesa_config['callback'];
        $this->callBackUrlEvent = $mpesa_config['callbackevents'];
        $this->short_code = $mpesa_config['short_code'];
    ...
    public function STKPushSimulation($TransactionType, $Amount, $PartyA, $PhoneNumber, $AccountReference, $TransactionDesc, $Remark)
    {
        ...
        $data = array(
            ...
            'AccountReference' => $AccountReference,
            'TransactionDesc' => ucwords(strtolower(str_replace("_", " ", $TransactionDesc))),
            'Remark' => $Remark,
        );
    ...
    public function STKPushSimulationEvent($TransactionType, $Amount, $PartyA, $PhoneNumber, $AccountReference, $TransactionDesc, $Remark)
    {
        $LipaNaMpesaPasskey = $this->pass_key;
        ...
        $data = array(
            ...
            'PartyB' => $PartyB,
            'PhoneNumber' => $PhoneNumber,
            'CallBackURL' => $this->callBackUrlEvent,
            'AccountReference' => $AccountReference,
            'TransactionDesc' => ucwords(strtolower(str_replace("_", " ", $TransactionDesc))),
            'Remark' => $Remark,
        );
